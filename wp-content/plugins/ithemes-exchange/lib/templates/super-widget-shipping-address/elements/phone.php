...
*/
?>
<?php do_action( 'it_exchange_super_widget_shipping_address_purchase_requirement_before_phone_element' ); ?>
<div class="it-exchange-phone">
	<?php it_exchange( 'shipping', 'phone' ); ?>
</div>
<?php do_action( 'it_exchange_super_widget_shipping_address_purchase_requirement_after_phone_element' ); ?>
