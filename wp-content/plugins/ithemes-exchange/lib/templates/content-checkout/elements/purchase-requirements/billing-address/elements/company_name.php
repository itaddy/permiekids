...
*/
?>
<?php do_action( 'it_exchange_content_checkout_billing_address_purchase_requirement_before_company_name_element' ); ?>
<div class="it-exchange-company-name">
	<?php it_exchange( 'billing', 'company-name' ); ?>
</div>
<?php do_action( 'it_exchange_content_checkout_billing_address_purchase_requirement_after_company_name_element' ); ?>
