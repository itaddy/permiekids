...
*/
?>
<?php do_action( 'it_exchange_content_checkout_shipping_address_purchase_requirement_before_address2_element' ); ?>
<div class="it-exchange-address2 it-exchange-clear-left">
	<?php it_exchange( 'shipping', 'address2', array( 'label' => false ) ); ?>
</div>
<?php do_action( 'it_exchange_content_checkout_shipping_address_purchase_requirement_after_address2_element' ); ?>
