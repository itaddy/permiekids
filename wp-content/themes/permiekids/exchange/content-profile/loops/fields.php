...
<?php do_action( 'it_exchange_content_profile_before_fields_loop' ); ?>
	...
	<?php do_action( 'it_exchange_content_profile_begin_fields_loop' ); ?>
		<?php foreach ( it_exchange_get_template_part_elements( 'content_profile', 'fields', array(  'avatar',  'first-name', 'last-name', 'motto', 'who_said_it', 'biography', 'four', 'location', 'family', 'occupation', 'experience', 'contact_information', 'email', 'facebook', 'twitter', 'linkedin', 'what_are_you_working_on', 'password1', 'password2' ) ) as $field ) : ?>
			<?php
			/**
