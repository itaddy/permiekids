...
*/
?>
<?php do_action( 'it_exchange_content_checkout_shipping_purchase_requirement_before_cancel_element' ); ?>
<div class="it-exchange-cancel-element">
	<?php it_exchange( 'shipping', 'cancel' ); ?>
</div>
<?php do_action( 'it_exchange_content_checkout_shipping_purchase_requirement_after_cancel_element' ); ?>
