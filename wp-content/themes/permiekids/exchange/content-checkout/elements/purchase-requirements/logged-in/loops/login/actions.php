...
*/
?>
<?php do_action( 'it_exchange_content_checkout_logged_in_purchase_requirement_login_before_actions_loop' ); ?>
<?php foreach ( it_exchange_get_template_part_elements( 'content_checkout/elements/purchase-requirements/logged-in/elements/login/', 'actions', array( 'login-button', 'recover' ) ) as $action ) : ?>
	<?php
	/**
	...
	?>
<?php endforeach; ?>
<?php do_action( 'it_exchange_content_checkout_logged_in_purchase_requirement_login_after_actions_loop' ); ?>
