...
*/
?>
<?php do_action( 'it_exchange_content_checkout_logged_in_purchase_requirement_not_logged_in_before_content_loop' ); ?>
<div class="it-exchange-content-checkout-logged-in-purchase-requirement-content">
	<?php do_action( 'it_exchange_content_checkout_logged_in_purchase_requirement_not_logged_in_begin_content_loop' ); ?>
	<?php foreach( it_exchange_get_template_part_elements( 'content-checkout-logged-in-purchase-requirements-not-logged-in', 'content', array( 'options', 'login', 'registration' ) ) as $element ) : ?>
		...
		?>
	<?php endforeach; ?>
	<?php do_action( 'it_exchange_content_checkout_logged_in_purchase_requirement_not_logged_in_end_content_loop' ); ?>
</div>
<?php do_action( 'it_exchange_content_checkout_logged_in_purchase_requirement_not_logged_in_after_content_loop' ); ?>
