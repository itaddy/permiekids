...
*/
?>
<?php do_action( 'it_exchange_super_widget_shipping_address_purchase_requirement_before_submit_element' ); ?>
<div class="it-exchange-submit">
	<?php it_exchange( 'shipping', 'submit' ); ?>
</div>
<?php do_action( 'it_exchange_super_widget_shipping_address_purchase_requirement_after_submit_element' ); ?>
