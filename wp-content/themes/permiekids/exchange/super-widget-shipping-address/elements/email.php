...
*/
?>
<?php do_action( 'it_exchange_super_widget_shipping_address_purchase_requirement_before_email_element' ); ?>
<div class="it-exchange-email">
	<?php it_exchange( 'shipping', 'email' ); ?>
</div>
<?php do_action( 'it_exchange_super_widget_shipping_address_purchase_requirement_after_email_element' ); ?>
